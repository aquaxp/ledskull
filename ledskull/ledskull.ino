...
#define ESP_LED 13 // WiFi module signal LED pin
#define SIG_PIN 14 // strip signal pin - D5
#define LEN_NUM 5  // strip LED number

const char *apSsid = "LED_SKULL_NOMAP";
const char *apPassword = "ledskullpassword";
const char *OTAName = "ESP8266";
const char *OTAPassword = "esp8266";
const char* mdnsName = "skull";

ESP8266WiFiMulti wifiMulti;
ESP8266WebServer server = ESP8266WebServer(80);     // http server on port 80
WebSocketsServer webSocket = WebSocketsServer(81);  // WebSocket server on port 81
File fsUploadFile; // temporary storage for uploaded file
void stripCallback();
NeoPatterns strip(5, 14, NEO_GRB + NEO_KHZ400, &stripCallback);
